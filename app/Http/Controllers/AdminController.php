...
class AdminController extends Controller
{
    public function index()
    {
        ...
        $totalDiproses = Order::whereDate('created_at', today())
            ->where('status', 'process')
            ->count();

        $totalSelesai = Order::whereDate('created_at', today())
        ...
        $grafikLabels = $grafik->pluck('hari');
        $grafikData   = $grafik->pluck('total');
