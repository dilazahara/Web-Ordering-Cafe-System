...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // ── ACCOUNT ADMIN ─────────────────────────────────
    Route::get('/account/profil',           [AccountAdminController::class, 'profil'])->name('account.profil');
    Route::put('/account/update',           [AccountAdminController::class, 'updateProfil'])->name('account.update');
    Route::get('/account/ganti-sandi',      [AccountAdminController::class, 'gantiSandi'])->name('account.ganti-sandi');
    Route::put('/account/update-password',  [AccountAdminController::class, 'updatePassword'])->name('account.update-password');
    Route::post('/account/update-avatar',   [AccountAdminController::class, 'updateAvatar'])->name('account.update-avatar');
    Route::post('/account/verify-password', [AccountAdminController::class, 'verifyPassword'])->name('account.verify-password');
...
Route::middleware(['auth', 'role:dapur'])->prefix('dapur')->name('dapur.')->group(function () {
    ...
    Route::get('/proses',        [DapurController::class, 'proses'])->name('proses');
...
Route::middleware('auth')
    ->get('/konfirmasi', [KonfirmasiPesananController::class, 'index'])
    ->name('konfirmasi');