...
.avatar-preview {
    ...
    font-size: 32px; font-weight: 800; color: white; background-color: #ea580c;
}
...
.btn-edit-avatar {
    ...
    background: #ea580c; color: white; border: 2.5px solid white; border-radius: 20px;
...
.btn-edit-avatar:hover { background: #c2410c; }
...
/* ── BADGE ── */
.info-badge { display: inline-flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: 8px; font-size: 12px; font-weight: 600; background: #fff7ed; color: #c2410c; }
...
.btn-save { padding: 10px 24px; border-radius: 10px; border: none; background: #ea580c; color: white; font-size: 14px; font-weight: 700; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; transition: .2s; box-shadow: 0 4px 12px rgba(234,88,12,0.25); font-family: 'Plus Jakarta Sans', sans-serif; }
.btn-save:hover { background: #c2410c; transform: translateY(-1px); }
...
.pw-lock-icon svg { width: 26px; height: 26px; stroke: #ea580c; fill: none; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; }
...
.btn-verify {
    ...
    background: #ea580c; color: white; font-size: 14px; font-weight: 700;
    cursor: pointer; font-family: 'Plus Jakarta Sans', sans-serif;
    transition: background .2s, transform .15s;
    box-shadow: 0 4px 12px rgba(234,88,12,0.25);
}
.btn-verify:hover { background: #c2410c; transform: translateY(-1px); }
...
.btn-primary { padding: 10px 20px; border-radius: 10px; border: none; background: #ea580c; color: white; font-size: 14px; font-weight: 700; cursor: pointer; transition: background .15s; font-family: 'Plus Jakarta Sans', sans-serif; }
...
.btn-capture:hover { background: #c2410c; }
    ...
    <form action="{{ route('dapur.account.update') }}" method="POST">
        ...
        <div class="card">
            ...
            <div class="card-section">
                ...
                <div class="avatar-row">
                    ...
                    @php
                        ...
                        $initial   = strtoupper(substr(auth()->user()->name ?? 'D', 0, 1));
                    @endphp
                ...
                <div class="form-grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input"
                               value="{{ ucfirst(auth()->user()->role ?? 'Dapur') }}" readonly>
                    </div>
                    <div class="form-group">
            ...
            <div class="card-footer">
                <a href="{{ route('dapur.proses') }}" class="btn-cancel">Kembali</a>
    ...
    <div class="modal-box">
        ...
        <div class="verify-body">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:16px;">
                <div style="width:44px;height:44px;border-radius:50%;background:#fff7ed;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#ea580c" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:22px;height:22px;">
...
const AVATAR_AJAX_URL = "{{ route('dapur.account.update-avatar') }}";
const VERIFY_URL      = "{{ route('dapur.account.verify-password') }}";
...
document.getElementById('btnConfirmDelete').addEventListener('click', async function() {
    ...
    preview.style.backgroundImage = ''; preview.style.backgroundColor = '#ea580c';
