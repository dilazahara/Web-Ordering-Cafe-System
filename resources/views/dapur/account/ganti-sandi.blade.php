...
<div class="main">
    ...
    <div class="page-header">
        ...
        <div>
            ...
            <p>
                Perbarui kata sandi akun dapur Anda
            </p>
            ...
            <div class="tips-grid">
                ...
                <div class="tip-item">
                    ...
                    <div class="tip-text">
                        ...
                        <p>Semakin panjang semakin aman</p>
                    </div>
                </div>
    ...
    <form
        action="{{ route('dapur.account.update-password') }}"
        method="POST"
    >
